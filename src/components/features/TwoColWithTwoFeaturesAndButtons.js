...
export default ({
  subheading = "For artist",
  heading = (
    <>
      We have the most exiting <span tw="text-primary-500">Opportunities</span> waiting for you to apply.
    </>
  ),
  ...
  const defaultFeatures = [
    {
      ...
      description: "We have the best Organisers around the world find out the opportunity from Dashboard section"
    },
    {
      Icon: MoneyIcon,
      title: "Get offer",
      description: "Apply to the opportunity you are best at & Get exiting offer to perform"
    }
  ];
